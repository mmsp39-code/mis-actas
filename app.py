...
with st.sidebar:
    ...
    instaladores = st.text_input("Instaladores", "Técnico 1 JOSE TECNICO 2 PEPE")
    ...
    if excel_file:
        with st.spinner("Procesando..."):
            ...
            if os.path.exists('logo_instituciona.png'):
                p_logo.add_run().add_picture('logo_instituciona.png', width=Inches(6.0))
            ...
            try:
                if os.path.exists('logo_adasa.png'): p_l.add_run().add_picture('logo_adasa.png', width=Inches(1.2))
                p_l.add_run("    ")
                if os.path.exists('logo_inelcom.png'): p_l.add_run().add_picture('logo_inelcom.png', width=Inches(1.2))
            except: pass
